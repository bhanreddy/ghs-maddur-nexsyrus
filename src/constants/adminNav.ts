...
export function buildAdminNavActions(t: TFunction): AdminNavAction[] {
  return [
    ...
    { title: 'Exam Analytics', icon: 'analytics-outline', route: '/admin/exam-analytics', tier: 'ACADEMIC', gradient: ['#1D4ED8', '#7C3AED'], category: 'Analytics', permission: 'admin.manage' },
